...
class UserRegisterForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs.update(
            {"placeholder": "Придумайте свой логин", "class": "form-control", "autocomplete": "off"})
        self.fields['email'].widget.attrs.update(
            {"placeholder": "Введите свой email", "class": "form-control", "autocomplete": "off"})
        self.fields['first_name'].widget.attrs.update(
            {"placeholder": "Ваше имя", "class": "form-control", "autocomplete": "off"})
        self.fields['last_name'].widget.attrs.update(
            {"placeholder": "Ваша фамилия", "class": "form-control", "autocomplete": "off"})
        self.fields['password1'].widget.attrs.update(
            {"placeholder": "Придумайте свой пароль", "class": "form-control", "autocomplete": "off"})
        self.fields['password2'].widget.attrs.update(
            {"placeholder": "Повторите придуманный пароль", "class": "form-control", "autocomplete": "off"})
